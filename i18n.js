...
;(function () {
  ...
  en: {
    ...
    'help.l1.desc':    'Click Buy License in the trial notification. Complete payment via QRIS, virtual account, GoPay, or other methods.',
    ...
    'overlay.suspendedTitle': 'Account Suspended',
    'overlay.suspendedSub':   'This account has been suspended. Please contact support.',
    'overlay.priceLabel':     '30-day license',
    'overlay.promoLabel':     'Launching Promo',
    'overlay.publishedPrice': 'Original price',
    'overlay.buyBtn': 'Buy License',
    ...
    'settings.updateErrorDetail': (msg) => `Update failed: ${msg}`,
  ...
  id: {
    ...
    'help.l1.desc':    'Klik Beli Lisensi di notifikasi trial. Selesaikan pembayaran via QRIS, virtual account, GoPay, atau metode lainnya.',
    ...
    'overlay.suspendedTitle': 'Akun Ditangguhkan',
    'overlay.suspendedSub':   'Akun ini telah ditangguhkan. Silakan hubungi dukungan.',
    'overlay.priceLabel':     'Lisensi 30 hari',
    'overlay.promoLabel':     'Promo Peluncuran',
    'overlay.publishedPrice': 'Harga asli',
    'overlay.buyBtn': 'Beli Lisensi',
    ...
    'status.processing':  'Memproses rekaman\u2026',
    ...
    'settings.updateErrorDetail': (msg) => `Pembaruan gagal: ${msg}`,
